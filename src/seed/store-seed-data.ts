...
// Seed data for initial Dolan setup
...
export const seedProducts = [
  {
    ...
    description: 'This is a sample product for your Dolan store.',
...
export const seedGlobals = {
  ...
  footer: {
    ...
    copyright: '© 2024 Dolan. All rights reserved.',
  },
  settings: {
    siteName: 'Dolan',
